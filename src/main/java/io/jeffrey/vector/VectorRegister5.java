...
public class VectorRegister5 extends VectorRegister4 {
    ...
    public void set4(double x, double y) {
        x_4 = x;
        y_4 = y;
    }
    ...
    public void mult_4_by(double s) {
        x_4 *= s;
        y_4 *= s;
    }
