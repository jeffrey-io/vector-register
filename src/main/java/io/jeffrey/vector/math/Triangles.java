...
public class Triangles {
     ...
     *
     * 
     * @param reg vector register with V{0,1,2} the vertices of the triangle and V3 is the point to see if it is within
     * @return if V3 is in the triangle defined by V0, V1, V2
     */
    public static boolean pointInsideTriangle_Destructively(VectorRegister4 reg) {
        reg.sub_0_from_1();
        reg.sub_0_from_2();
        reg.sub_0_from_3();
        if (reg.invert_1_2()) {
